...
if "Rating" in df.columns:
    ...
    fig_rating = px.bar(city_rating, x="City", y="Rating", title="Avaliação")
    col5.plotly_chart(fig_rating, use_container_width=True)
else:
    st.error("A coluna 'Rating' não foi encontrada no arquivo CSV.")
    col5.write("A coluna 'Rating' não está disponível.")
